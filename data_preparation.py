...
def parse_video_annos(anno_inp, video_ids, discard_value=None, drop_all=False):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_dir', type=str, default='/media/vthuynh/XProject/emotion/abaw8/affwild2/', help='Root data folder')
    parser.add_argument('--out_dir', type=str, default='/media/vthuynh/XProject/emotion/abaw8/affwild2/', help='Out data folder')
    args = parser.parse_args()

    root_dir = pathlib.Path(args.root_dir)
    cropped_aligned = root_dir / 'cropped_aligned'
    annotations = root_dir / '8th_ABAW_Annotations'
    ...
    for chal in challenges:
        ...
        if 'MTL' not in chal_name:
            ...
            print(f'Un-supported {chal_name} challenge!')
